...
betadist.bray.dada2.basic <- betadist.function(fox, Method=="dada2", Filt=="basic", "bray", TRUE)
betadist.dice.dada2.basic <- betadist.function(fox, Method=="dada2", Filt=="basic", "bray", FALSE)
betadist.bray.dada2.standard <- betadist.function(fox, Method=="dada2", Filt=="standard", "bray", TRUE)
betadist.dice.dada2.standard <- betadist.function(fox, Method=="dada2", Filt=="standard", "bray", FALSE)
betadist.bray.dada2.extra <- betadist.function(fox, Method=="dada2", Filt=="extra", "bray", TRUE)
betadist.dice.dada2.extra <- betadist.function(fox, Method=="dada2", Filt=="extra", "bray", FALSE)

betadist.bray.deblur.basic <- betadist.function(fox, Method=="deblur", Filt=="basic", "bray", TRUE)
betadist.dice.deblur.basic <- betadist.function(fox, Method=="deblur", Filt=="basic", "bray", FALSE)
betadist.bray.deblur.standard <- betadist.function(fox, Method=="deblur", Filt=="standard", "bray", TRUE)
betadist.dice.deblur.standard <- betadist.function(fox, Method=="deblur", Filt=="standard", "bray", FALSE)
betadist.bray.deblur.extra <- betadist.function(fox, Method=="deblur", Filt=="extra", "bray", TRUE)
betadist.dice.deblur.extra <- betadist.function(fox, Method=="deblur", Filt=="extra", "bray", FALSE)

betadist.bray.vsearch.basic <- betadist.function(fox, Method=="vsearch", Filt=="basic", "bray", TRUE)
betadist.dice.vsearch.basic <- betadist.function(fox, Method=="vsearch", Filt=="basic", "bray", FALSE)
betadist.bray.vsearch.standard <- betadist.function(fox, Method=="vsearch", Filt=="standard", "bray", TRUE)
betadist.dice.vsearch.standard <- betadist.function(fox, Method=="vsearch", Filt=="standard", "bray", FALSE)
betadist.bray.vsearch.extra <- betadist.function(fox, Method=="vsearch", Filt=="extra", "bray", TRUE)
betadist.dice.vsearch.extra <- betadist.function(fox, Method=="vsearch", Filt=="extra", "bray", FALSE)
...
all.betadist.df$BetaType[which(all.betadist.df$BetaType==TRUE)] <- "bray"
all.betadist.df$BetaType[which(all.betadist.df$BetaType==FALSE)] <- "dice"

rm(betadist.dice.vsearch.extra, betadist.dice.vsearch.standard, betadist.dice.vsearch.basic,
   betadist.bray.vsearch.extra, betadist.bray.vsearch.standard, betadist.bray.vsearch.basic,
   betadist.dice.dada2.extra, betadist.dice.dada2.standard, betadist.dice.dada2.basic,
   betadist.bray.dada2.extra, betadist.bray.dada2.standard, betadist.bray.dada2.basic,
   betadist.dice.deblur.extra, betadist.dice.deblur.standard, betadist.dice.deblur.basic,
...
##plot; save as 15_betadist_boxplot; export at 1000x1000
