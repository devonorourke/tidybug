...
betadist.bray.dada2.basic <- betadist.function(fox, Method=="dada2", Filt=="basic", "bray", FALSE)
betadist.dice.dada2.basic <- betadist.function(fox, Method=="dada2", Filt=="basic", "bray", TRUE)
betadist.bray.dada2.standard <- betadist.function(fox, Method=="dada2", Filt=="standard", "bray", FALSE)
betadist.dice.dada2.standard <- betadist.function(fox, Method=="dada2", Filt=="standard", "bray", TRUE)
betadist.bray.dada2.extra <- betadist.function(fox, Method=="dada2", Filt=="extra", "bray", FALSE)
betadist.dice.dada2.extra <- betadist.function(fox, Method=="dada2", Filt=="extra", "bray", TRUE)

betadist.bray.deblur.basic <- betadist.function(fox, Method=="deblur", Filt=="basic", "bray", FALSE)
betadist.dice.deblur.basic <- betadist.function(fox, Method=="deblur", Filt=="basic", "bray", TRUE)
betadist.bray.deblur.standard <- betadist.function(fox, Method=="deblur", Filt=="standard", "bray", FALSE)
betadist.dice.deblur.standard <- betadist.function(fox, Method=="deblur", Filt=="standard", "bray", TRUE)
betadist.bray.deblur.extra <- betadist.function(fox, Method=="deblur", Filt=="extra", "bray", FALSE)
betadist.dice.deblur.extra <- betadist.function(fox, Method=="deblur", Filt=="extra", "bray", TRUE)

betadist.bray.vsearch.basic <- betadist.function(fox, Method=="vsearch", Filt=="basic", "bray", FALSE)
betadist.dice.vsearch.basic <- betadist.function(fox, Method=="vsearch", Filt=="basic", "bray", TRUE)
betadist.bray.vsearch.standard <- betadist.function(fox, Method=="vsearch", Filt=="standard", "bray", FALSE)
betadist.dice.vsearch.standard <- betadist.function(fox, Method=="vsearch", Filt=="standard", "bray", TRUE)
betadist.bray.vsearch.extra <- betadist.function(fox, Method=="vsearch", Filt=="extra", "bray", FALSE)
betadist.dice.vsearch.extra <- betadist.function(fox, Method=="vsearch", Filt=="extra", "bray", TRUE)
...
##plot; save as 14_unrarefied_betadist_boxplot; export at 1000x1000
